...
#define LCF_INTVEC0_START   0x8004E000
...
//size = 2M;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80000000,           size=320k);
        map not_cached (dest=bus:sri, dest_offset=0xa0000000, reserved, size=320k);
...
//del        group  bmh_1 (ordered, run_addr=0x80020000)
//del        {
//del            select "*.bmhd_1";
//del        }
...
//DEL        "_A9_DATA_" := 0x00000000;
//DEL        "_A9_MEM" = "_A9_DATA_";
...
//DEL     "_lc_u_trap_tab_tc0" = TRAPTAB0;
//DEL         "__TRAPTAB_CPU0" := TRAPTAB0;
    }
