...
void Mcu_ClearColdResetStatus(void)
{
  ...
  #endif
  {
    ...
    SCU_RSTCON2.B.CLRC =  MCU_CLEAR_COLD_RESET_REG;
  ...
  if((ClockSel == 1U) && (VcoByPassStatus == MCU_PLLSTAT_NORMAL_MODE))
  {
    ...
    if( CurrentPllFreq > (MCU_BACKUP_FREQ + MCU_BACKUP_FREQ_TOLERANCE))
    {
      ...
      do
      {
        ...
        K2RampUpDelayCount = CurrentPllFreq * K2RampUpDelay;

        /* Divide the count by 2 */
        K2RampUpDelayCount = (K2RampUpDelayCount >> 1U);
