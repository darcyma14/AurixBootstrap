...
#else
extern __indirect int EAXmain(void);
#endif
...
/* 
   ...
   The mathematical function name is 밅eiling(r)�.


   Demo configuration: 
   tPF = 30 ns, tPFECC = 10 ns, tDF = 200 ns, 
   tDFECC = 20 ns with fFSI2 = 80 MHz and fFSI = 80 MHz: 
