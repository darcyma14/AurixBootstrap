...
void IrqCcu6_Init(void)
{
  ...
  #if (IRQ_CCU60_EXIST == STD_ON)
  SRC_CCU60SR0.U |=(IRQ_CCU60_SR0_TOS | IRQ_CCU60_SR0_PRIO);
  SRC_CCU60SR1.U |=(IRQ_CCU60_SR1_TOS | IRQ_CCU60_SR1_PRIO);
  SRC_CCU60SR2.U |=(IRQ_CCU60_SR2_TOS | IRQ_CCU60_SR2_PRIO);
  SRC_CCU60SR3.U |=(IRQ_CCU60_SR3_TOS | IRQ_CCU60_SR3_PRIO);
  #endif

  #if (IRQ_CCU61_EXIST == STD_ON)
  SRC_CCU61SR0.U |=(IRQ_CCU61_SR0_TOS | IRQ_CCU61_SR0_PRIO);
  SRC_CCU61SR1.U |=(IRQ_CCU61_SR1_TOS | IRQ_CCU61_SR1_PRIO);
  SRC_CCU61SR2.U |=(IRQ_CCU61_SR2_TOS | IRQ_CCU61_SR2_PRIO);
  SRC_CCU61SR3.U |=(IRQ_CCU61_SR3_TOS | IRQ_CCU61_SR3_PRIO);
  #endif
...
void IrqGpt_Init(void)
{
  ...
  #if (IRQ_GPT120_EXIST == STD_ON)
  SRC_GPT120CIRQ.U |= (IRQ_GPT120_CARPEL_TOS | IRQ_GPT120_CARPEL_PRIO);
  SRC_GPT120T2.U   |= (IRQ_GPT120_T2_TOS | IRQ_GPT120_T2_PRIO);
  SRC_GPT120T3.U   |= (IRQ_GPT120_T3_TOS | IRQ_GPT120_T3_PRIO);
  SRC_GPT120T4.U   |= (IRQ_GPT120_T4_TOS | IRQ_GPT120_T4_PRIO);
  SRC_GPT120T5.U   |= (IRQ_GPT120_T5_TOS | IRQ_GPT120_T5_PRIO);
  SRC_GPT120T6.U   |= (IRQ_GPT120_T6_TOS | IRQ_GPT120_T6_PRIO);
  #endif
...
void IrqGtm_Init(void)
{
  ...
  #if (IRQ_GTM_AEI_EXIST == STD_ON)
  SRC_GTMAEIIRQ.U  |= (IRQ_GTM_AEI_TOS | IRQ_GTM_AEI_PRIO);
  #endif



  #if (IRQ_GTM_ERR_EXIST == STD_ON)
  SRC_GTMERR.U   |= (IRQ_GTM_ERR_SR_TOS | IRQ_GTM_ERR_SR_PRIO);
  #endif

  #if (IRQ_GTM_TIM0_EXIST == STD_ON)
  SRC_GTMTIM00.U   |= (IRQ_GTM_TIM0_SR0_TOS | IRQ_GTM_TIM0_SR0_PRIO);
  SRC_GTMTIM01.U   |= (IRQ_GTM_TIM0_SR1_TOS | IRQ_GTM_TIM0_SR1_PRIO);
  SRC_GTMTIM02.U   |= (IRQ_GTM_TIM0_SR2_TOS | IRQ_GTM_TIM0_SR2_PRIO);
  SRC_GTMTIM03.U   |= (IRQ_GTM_TIM0_SR3_TOS | IRQ_GTM_TIM0_SR3_PRIO);
  SRC_GTMTIM04.U   |= (IRQ_GTM_TIM0_SR4_TOS | IRQ_GTM_TIM0_SR4_PRIO);
  SRC_GTMTIM05.U   |= (IRQ_GTM_TIM0_SR5_TOS | IRQ_GTM_TIM0_SR5_PRIO);
  SRC_GTMTIM06.U   |= (IRQ_GTM_TIM0_SR6_TOS | IRQ_GTM_TIM0_SR6_PRIO);
  SRC_GTMTIM07.U   |= (IRQ_GTM_TIM0_SR7_TOS | IRQ_GTM_TIM0_SR7_PRIO);
  #endif
  ...
  #if (IRQ_GTM_TOM0_EXIST == STD_ON)
  SRC_GTMTOM00.U   |= (IRQ_GTM_TOM0_SR0_TOS | IRQ_GTM_TOM0_SR0_PRIO);
  SRC_GTMTOM01.U   |= (IRQ_GTM_TOM0_SR1_TOS | IRQ_GTM_TOM0_SR1_PRIO);
  SRC_GTMTOM02.U   |= (IRQ_GTM_TOM0_SR2_TOS | IRQ_GTM_TOM0_SR2_PRIO);
  SRC_GTMTOM03.U   |= (IRQ_GTM_TOM0_SR3_TOS | IRQ_GTM_TOM0_SR3_PRIO);
  SRC_GTMTOM04.U   |= (IRQ_GTM_TOM0_SR4_TOS | IRQ_GTM_TOM0_SR4_PRIO);
  SRC_GTMTOM05.U   |= (IRQ_GTM_TOM0_SR5_TOS | IRQ_GTM_TOM0_SR5_PRIO);
  SRC_GTMTOM06.U   |= (IRQ_GTM_TOM0_SR6_TOS | IRQ_GTM_TOM0_SR6_PRIO);
  SRC_GTMTOM07.U   |= (IRQ_GTM_TOM0_SR7_TOS | IRQ_GTM_TOM0_SR7_PRIO);
  #endif

  #if (IRQ_GTM_TOM1_EXIST == STD_ON)
  SRC_GTMTOM10.U   |= (IRQ_GTM_TOM1_SR0_TOS | IRQ_GTM_TOM1_SR0_PRIO);
  SRC_GTMTOM11.U   |= (IRQ_GTM_TOM1_SR1_TOS | IRQ_GTM_TOM1_SR1_PRIO);
  SRC_GTMTOM12.U   |= (IRQ_GTM_TOM1_SR2_TOS | IRQ_GTM_TOM1_SR2_PRIO);
  SRC_GTMTOM13.U   |= (IRQ_GTM_TOM1_SR3_TOS | IRQ_GTM_TOM1_SR3_PRIO);
  SRC_GTMTOM14.U   |= (IRQ_GTM_TOM1_SR4_TOS | IRQ_GTM_TOM1_SR4_PRIO);
  SRC_GTMTOM15.U   |= (IRQ_GTM_TOM1_SR5_TOS | IRQ_GTM_TOM1_SR5_PRIO);
  SRC_GTMTOM16.U   |= (IRQ_GTM_TOM1_SR6_TOS | IRQ_GTM_TOM1_SR6_PRIO);
  SRC_GTMTOM17.U   |= (IRQ_GTM_TOM1_SR7_TOS | IRQ_GTM_TOM1_SR7_PRIO);
  #endif
...
void IrqGpsrGroup_Init(void)
{
  ...
  #if (IRQ_GPSRGROUP0_EXIST == STD_ON)
  SRC_GPSR00.U |= (IRQ_GPSRGROUP0_SR0_TOS | IRQ_GPSRGROUP0_SR0_PRIO);
...
void IrqSpi_Init(void)
{
  ...
  #if (IRQ_QSPI0_EXIST == STD_ON)
  SRC_QSPI0TX.U  |=(IRQ_QSPI0_TX_TOS | IRQ_QSPI0_TX_PRIO);
  SRC_QSPI0RX.U  |=(IRQ_QSPI0_RX_TOS | IRQ_QSPI0_RX_PRIO);
  SRC_QSPI0ERR.U |=(IRQ_QSPI0_ERR_TOS | IRQ_QSPI0_ERR_PRIO);
  SRC_QSPI0PT.U  |=(IRQ_QSPI0_PT_TOS | IRQ_QSPI0_PT_PRIO);
  SRC_QSPI0U.U   |=(IRQ_QSPI0_UD_TOS | IRQ_QSPI0_UD_PRIO);
  #endif /*IRQ_QSPI0_EXIST == STD_ON*/

  #if (IRQ_QSPI1_EXIST == STD_ON)
  SRC_QSPI1TX.U  |=(IRQ_QSPI1_TX_TOS | IRQ_QSPI1_TX_PRIO);
  SRC_QSPI1RX.U  |=(IRQ_QSPI1_RX_TOS | IRQ_QSPI1_RX_PRIO);
  SRC_QSPI1ERR.U |=(IRQ_QSPI1_ERR_TOS | IRQ_QSPI1_ERR_PRIO);
  SRC_QSPI1PT.U  |=(IRQ_QSPI1_PT_TOS | IRQ_QSPI1_PT_PRIO);
  SRC_QSPI1U.U   |=(IRQ_QSPI1_UD_TOS | IRQ_QSPI1_UD_PRIO);
  #endif

  #if (IRQ_QSPI2_EXIST == STD_ON)
  SRC_QSPI2TX.U  |=(IRQ_QSPI2_TX_TOS | IRQ_QSPI2_TX_PRIO);
  SRC_QSPI2RX.U  |=(IRQ_QSPI2_RX_TOS | IRQ_QSPI2_RX_PRIO);
  SRC_QSPI2ERR.U |=(IRQ_QSPI2_ERR_TOS | IRQ_QSPI2_ERR_PRIO);
  SRC_QSPI2PT.U  |=(IRQ_QSPI2_PT_TOS | IRQ_QSPI2_PT_PRIO);
  SRC_QSPI2HC.U  |=(IRQ_QSPI2_HC_TOS | IRQ_QSPI2_HC_PRIO);
  SRC_QSPI2U.U   |=(IRQ_QSPI2_UD_TOS | IRQ_QSPI2_UD_PRIO);
  #endif

  #if (IRQ_QSPI3_EXIST == STD_ON)
  SRC_QSPI3TX.U  |=(IRQ_QSPI3_TX_TOS | IRQ_QSPI3_TX_PRIO);
  SRC_QSPI3RX.U  |=(IRQ_QSPI3_RX_TOS | IRQ_QSPI3_RX_PRIO);
  SRC_QSPI3ERR.U |=(IRQ_QSPI3_ERR_TOS | IRQ_QSPI3_ERR_PRIO);
  SRC_QSPI3PT.U  |=(IRQ_QSPI3_PT_TOS | IRQ_QSPI3_PT_PRIO);
  SRC_QSPI3HC.U  |=(IRQ_QSPI3_HC_TOS | IRQ_QSPI3_HC_PRIO);
  SRC_QSPI3U.U   |=(IRQ_QSPI3_UD_TOS | IRQ_QSPI3_UD_PRIO);
  #endif
...
void IrqAdc_Init(void)
{
  ...
  #if (IRQ_ADC0_EXIST == STD_ON)
  SRC_VADCG0SR0.U |= (IRQ_ADC0_SR0_TOS | IRQ_ADC0_SR0_PRIO);
  SRC_VADCG0SR1.U |= (IRQ_ADC0_SR1_TOS | IRQ_ADC0_SR1_PRIO);
  SRC_VADCG0SR2.U |= (IRQ_ADC0_SR2_TOS | IRQ_ADC0_SR2_PRIO);
  SRC_VADCG0SR3.U |= (IRQ_ADC0_SR3_TOS | IRQ_ADC0_SR3_PRIO);
  #endif

  #if (IRQ_ADC1_EXIST == STD_ON)
  SRC_VADCG1SR0.U |= (IRQ_ADC1_SR0_TOS | IRQ_ADC1_SR0_PRIO);
  SRC_VADCG1SR1.U |= (IRQ_ADC1_SR1_TOS | IRQ_ADC1_SR1_PRIO);
  SRC_VADCG1SR2.U |= (IRQ_ADC1_SR2_TOS | IRQ_ADC1_SR2_PRIO);
  SRC_VADCG1SR3.U |= (IRQ_ADC1_SR3_TOS | IRQ_ADC1_SR3_PRIO);
  #endif

  #if (IRQ_ADC2_EXIST == STD_ON)
  SRC_VADCG2SR0.U |= (IRQ_ADC2_SR0_TOS | IRQ_ADC2_SR0_PRIO);
  SRC_VADCG2SR1.U |= (IRQ_ADC2_SR1_TOS | IRQ_ADC2_SR1_PRIO);
  SRC_VADCG2SR2.U |= (IRQ_ADC2_SR2_TOS | IRQ_ADC2_SR2_PRIO);
  SRC_VADCG2SR3.U |= (IRQ_ADC2_SR3_TOS | IRQ_ADC2_SR3_PRIO);
  #endif

  #if (IRQ_ADC3_EXIST == STD_ON)
  SRC_VADCG3SR0.U |= (IRQ_ADC3_SR0_TOS | IRQ_ADC3_SR0_PRIO);
  SRC_VADCG3SR1.U |= (IRQ_ADC3_SR1_TOS | IRQ_ADC3_SR1_PRIO);
  SRC_VADCG3SR2.U |= (IRQ_ADC3_SR2_TOS | IRQ_ADC3_SR2_PRIO);
  SRC_VADCG3SR3.U |= (IRQ_ADC3_SR3_TOS | IRQ_ADC3_SR3_PRIO);
  #endif

  #if (IRQ_ADCCG0_EXIST == STD_ON)
  SRC_VADCCG0SR0.U |= (IRQ_ADCCG0_SR0_TOS | IRQ_ADCCG0_SR0_PRIO);
  SRC_VADCCG0SR1.U |= (IRQ_ADCCG0_SR1_TOS | IRQ_ADCCG0_SR1_PRIO);
  SRC_VADCCG0SR2.U |= (IRQ_ADCCG0_SR2_TOS | IRQ_ADCCG0_SR2_PRIO);
  SRC_VADCCG0SR3.U |= (IRQ_ADCCG0_SR3_TOS | IRQ_ADCCG0_SR3_PRIO);
  #endif
...
void IrqFlexray_Init(void)
{
  ...
  #if (IRQ_FLEXRAY0_EXIST == STD_ON)
  SRC_ERAY_ERAY0_INT0.U |= (IRQ_FLEXRAY0_SR0_TOS | IRQ_FLEXRAY0_SR0_PRIO);
  SRC_ERAY_ERAY0_INT1.U |= (IRQ_FLEXRAY0_SR1_TOS | IRQ_FLEXRAY0_SR1_PRIO);
  SRC_ERAY_ERAY0_TINT0.U |=
                  (IRQ_FLEXRAY0_TIMER_INT0_TOS | IRQ_FLEXRAY0_TIMER_INT0_PRIO);
  SRC_ERAY_ERAY0_TINT1.U |=
                  (IRQ_FLEXRAY0_TIMER_INT1_TOS | IRQ_FLEXRAY0_TIMER_INT1_PRIO);
  SRC_ERAY_ERAY0_NDAT0.U |=
                    (IRQ_FLEXRAY0_NEW_DATA0_TOS | IRQ_FLEXRAY0_NEW_DATA0_PRIO);
  SRC_ERAY_ERAY0_NDAT1.U |=
                    (IRQ_FLEXRAY0_NEW_DATA1_TOS | IRQ_FLEXRAY0_NEW_DATA1_PRIO);
  SRC_ERAY_ERAY0_MBSC0.U |= (IRQ_FLEXRAY0_MBSC0_TOS | IRQ_FLEXRAY0_MBSC0_PRIO);
  SRC_ERAY_ERAY0_MBSC1.U |= (IRQ_FLEXRAY0_MBSC1_TOS | IRQ_FLEXRAY0_MBSC1_PRIO);
  SRC_ERAY_ERAY0_OBUSY.U |=
                        (IRQ_FLEXRAY0_OB_BUSY_TOS | IRQ_FLEXRAY0_OB_BUSY_PRIO);
  SRC_ERAY_ERAY0_IBUSY.U |=
...
{
  #if (IRQ_ETH_EXIST == STD_ON)
  SRC_ETH.U |= (IRQ_ETH_SR_TOS | IRQ_ETH_SR_PRIO);
  #endif
}
...
void IrqDma_Init(void)
{
  ...
  #if (IRQ_DMA_CH0TO15_EXIST == STD_ON)
  SRC_DMACH0.U |= (IRQ_DMA_CHANNEL0_SR_TOS | IRQ_DMA_CHANNEL0_SR_PRIO);
  SRC_DMACH1.U |= (IRQ_DMA_CHANNEL1_SR_TOS | IRQ_DMA_CHANNEL1_SR_PRIO);
  SRC_DMACH2.U |= (IRQ_DMA_CHANNEL2_SR_TOS | IRQ_DMA_CHANNEL2_SR_PRIO);
  SRC_DMACH3.U |= (IRQ_DMA_CHANNEL3_SR_TOS | IRQ_DMA_CHANNEL3_SR_PRIO);
  SRC_DMACH4.U |= (IRQ_DMA_CHANNEL4_SR_TOS | IRQ_DMA_CHANNEL4_SR_PRIO);
  SRC_DMACH5.U |= (IRQ_DMA_CHANNEL5_SR_TOS | IRQ_DMA_CHANNEL5_SR_PRIO);
  SRC_DMACH6.U |= (IRQ_DMA_CHANNEL6_SR_TOS | IRQ_DMA_CHANNEL6_SR_PRIO);
  SRC_DMACH7.U |= (IRQ_DMA_CHANNEL7_SR_TOS | IRQ_DMA_CHANNEL7_SR_PRIO);
  SRC_DMACH8.U |= (IRQ_DMA_CHANNEL8_SR_TOS | IRQ_DMA_CHANNEL8_SR_PRIO);
  SRC_DMACH9.U |= (IRQ_DMA_CHANNEL9_SR_TOS | IRQ_DMA_CHANNEL9_SR_PRIO);
  SRC_DMACH10.U |= (IRQ_DMA_CHANNEL10_SR_TOS | IRQ_DMA_CHANNEL10_SR_PRIO);
  SRC_DMACH11.U |= (IRQ_DMA_CHANNEL11_SR_TOS | IRQ_DMA_CHANNEL11_SR_PRIO);
  SRC_DMACH12.U |= (IRQ_DMA_CHANNEL12_SR_TOS | IRQ_DMA_CHANNEL12_SR_PRIO);
  SRC_DMACH13.U |= (IRQ_DMA_CHANNEL13_SR_TOS | IRQ_DMA_CHANNEL13_SR_PRIO);
  SRC_DMACH14.U |= (IRQ_DMA_CHANNEL14_SR_TOS | IRQ_DMA_CHANNEL14_SR_PRIO);
  SRC_DMACH15.U |= (IRQ_DMA_CHANNEL15_SR_TOS | IRQ_DMA_CHANNEL15_SR_PRIO);
  #endif
...
void IrqStm_Init(void)
{
  ...
  #if (IRQ_STM0_EXIST == STD_ON)
  SRC_STM0SR0.U |= (IRQ_STM0_SR0_TOS | IRQ_STM0_SR0_PRIO);
  SRC_STM0SR1.U |= (IRQ_STM0_SR1_TOS | IRQ_STM0_SR1_PRIO);
  #endif
...
{
  #if (IRQ_SCU_EXIST == STD_ON)
  SRC_SCUDTS.U  |= (IRQ_SCU_DTS_BUSY_SR_TOS | IRQ_SCU_DTS_BUSY_SR_PRIO);
  SRC_SCUERU0.U |= (IRQ_SCU_ERU_SR0_TOS | IRQ_SCU_ERU_SR0_PRIO);
  SRC_SCUERU1.U |= (IRQ_SCU_ERU_SR1_TOS | IRQ_SCU_ERU_SR1_PRIO);
  SRC_SCUERU2.U |= (IRQ_SCU_ERU_SR2_TOS | IRQ_SCU_ERU_SR2_PRIO);
  SRC_SCUERU3.U |= (IRQ_SCU_ERU_SR3_TOS | IRQ_SCU_ERU_SR3_PRIO);
  #endif
...
void IrqPmu_Init(void)
{
  ...
  #if (IRQ_PMU0_SR0_EXIST == STD_ON)
  SRC_PMU00.U |= (IRQ_PMU0_SR0_TOS | IRQ_PMU0_SR0_PRIO);
  #endif

  #if (IRQ_PMU0_SR1_EXIST == STD_ON)
  SRC_PMU01.U |= (IRQ_PMU0_SR1_TOS | IRQ_PMU0_SR1_PRIO);
  #endif
...
void IrqSent_Init(void)
{
  ...
  #if (IRQ_SENT0_EXIST == STD_ON)
  SRC_SENT0.U |= (IRQ_SENT_SR0_TOS | IRQ_SENT_SR0_PRIO);
  #endif
  
  #if (IRQ_SENT1_EXIST == STD_ON)
  SRC_SENT1.U |= (IRQ_SENT_SR1_TOS | IRQ_SENT_SR1_PRIO);
  #endif
  
  #if (IRQ_SENT2_EXIST == STD_ON)
  SRC_SENT2.U |= (IRQ_SENT_SR2_TOS | IRQ_SENT_SR2_PRIO);
  #endif

  #if (IRQ_SENT3_EXIST == STD_ON)
  SRC_SENT3.U |= (IRQ_SENT_SR3_TOS | IRQ_SENT_SR3_PRIO);
  #endif
...
void IrqHsm_Init(void)
{
  ...
  #if (IRQ_HSM0_EXIST == STD_ON)
    SRC_HSM0.U  |= (IRQ_HSM_SR0_TOS | IRQ_HSM_SR0_PRIO);
  #endif
  
  #if (IRQ_HSM1_EXIST == STD_ON)
    SRC_HSM1.U  |= (IRQ_HSM_SR1_TOS | IRQ_HSM_SR1_PRIO);
  #endif
}
