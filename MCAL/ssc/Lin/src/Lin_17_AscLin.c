...
#if (LIN_17_ASCLIN_SW_MINOR_VERSION != 2U)
...
#define LIN_WAKEUP_NUMERATOR_VAL             (10U)
...
IFX_LOCAL_INLINE uint8 Lin_lHwGetRxDStatus(uint8 HwUnit);
...
static const Lin_17_AscLin_ConfigType* const Lin_kConfigPtr = &Lin_ConfigRoot[ 0 ];
...
void Lin_17_AscLin_Init( const Lin_17_AscLin_ConfigType* ConfigPtr )
{
    ...
    ReturnStatus = E_OK;
        ...
        {
            /* Report to  DET */
            Det_ReportError( ( uint16 )LIN_17_ASCLIN_MODULE_ID, LIN_MODULE_INSTANCE, LIN_SID_INIT, LIN_E_INVALID_POINTER );
        ...
        {
            /* Report to  DET */
            Det_ReportError( ( uint16 ) LIN_17_ASCLIN_MODULE_ID, LIN_MODULE_INSTANCE, LIN_SID_INIT, LIN_E_STATE_TRANSITION );
            ReturnStatus = E_NOT_OK;
        }
        else
        {
...
#endif
    {
        ...
        for( Chan = 0U; Chan < MaxChannel; Chan++ )
        {
            ...
            Lin_lHwInit( ModuleNo, ChannelConfigPtr->TimingConfig, ChannelConfigPtr->RxAlternatePinSelect );
...
static void Lin_lHwEnableAscLinIntr(uint8 HwUnit)
{
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    IntrSrc = *( ( volatile Ifx_SRC_SRCR_Bits * ) ( void * ) SRC_ASCLIN0TXADDR  + ( Offset ) );
    IntrSrc.CLRR = 1U;
    IntrSrc.SWSCLR = 1U;
    IntrSrc.IOVCLR = 1U;
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    *( ( volatile Ifx_SRC_SRCR_Bits * )( void * ) SRC_ASCLIN0TXADDR + Offset ) = IntrSrc;
    ...
    *( ( volatile Ifx_SRC_SRCR_Bits * ) ( void * ) SRC_ASCLIN0TXADDR + Offset ) = IntrSrc;
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    IntrSrc = *( ( volatile Ifx_SRC_SRCR_Bits * )( void * ) SRC_ASCLIN0RXADDR  + Offset );
    IntrSrc.CLRR = 1U;
    IntrSrc.SWSCLR = 1U;
    IntrSrc.IOVCLR = 1U;
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    *( ( volatile Ifx_SRC_SRCR_Bits * )( void * )SRC_ASCLIN0RXADDR + Offset ) = IntrSrc;
    ...
    *( ( volatile Ifx_SRC_SRCR_Bits * )( void * ) SRC_ASCLIN0RXADDR + Offset ) = IntrSrc;
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    IntrSrc = *( ( volatile Ifx_SRC_SRCR_Bits * )( void * ) SRC_ASCLIN0ERRADDR  + Offset );
    IntrSrc.CLRR = 1U;
    IntrSrc.SWSCLR = 1U;
    IntrSrc.IOVCLR = 1U;
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
    efficiently access the SFRs of multiple ASCLIN kernels.*/
    *( ( volatile Ifx_SRC_SRCR_Bits * )( void * ) SRC_ASCLIN0ERRADDR + Offset ) = IntrSrc;
                ...
                uint8 RxAlternatePinSelect)
{
    ...
    HeaderTimeOutVal = ( LIN_ASCLIN_LINHTIMER_HEADER_VAL + TimingConfig.InterByteResponseSpace + LIN_ASCLIN_FRAMECONREG_LEAD_VAL );
...
static void Lin_lHwStartTransmission(uint8 HwUnit, uint8 Channel)
{
  ...
  HwModulePtr->DATCON.B.RM = LIN_ENABLE_FLAG; /* Response mode = Reponsetype */
...
/*******************************************************************************
** Syntax           : IFX_LOCAL_INLINE uint8 Lin_lHwGetRxDStatus              **
**                      (uint8 HwUnit)                                        **
**                                                                            **
** Service ID       : NA                                                      **
**                                                                            **
...
IFX_LOCAL_INLINE void Lin_lHwInitKernelReg(uint8 HwUnit)
{
  ...
  LIN_HW_MODULE[HwUnit].KRST0.B.RST = LIN_ENABLE_FLAG;
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
  Readback = LIN_HW_MODULE[HwUnit].KRST0.U ;
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
  LIN_HW_MODULE[HwUnit].KRST1.B.RST = LIN_ENABLE_FLAG;
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
  Readback = LIN_HW_MODULE[HwUnit].KRST1.U ;  
  ...
  do
  {
   ...
   /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
   RstStatus = LIN_HW_MODULE[HwUnit].KRST0.B.RSTSTAT & TestLin_DebugMask01;
   #else
   /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
   RstStatus = LIN_HW_MODULE[HwUnit].KRST0.B.RSTSTAT;
   #endif
  }  
  ...
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
  LIN_HW_MODULE[HwUnit].KRSTCLR.B.CLR = LIN_ENABLE_FLAG;
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to
   efficiently access the SFRs of multiple ASCLIN kernels.*/
  Readback = LIN_HW_MODULE[HwUnit].KRSTCLR.U ;  
  /* Set End Init Protection */
  Mcal_SetENDINIT();
...
/* Re-Configure NUM and DEN to maintain 1 microtick = 1 tick so that
  ...
  HwModulePtr->BRG.B.NUMERATOR = LIN_WAKEUP_NUMERATOR_VAL;
  HwModulePtr->BRG.B.DENOMINATOR = LIN_WAKEUP_DENOMINATOR_VAL;
  ...
  HwModulePtr->FLAGSCLEAR.B.FEDC = 1U;
