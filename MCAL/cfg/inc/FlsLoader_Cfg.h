...
#define FLSLOADER_SW_MINOR_VERSION       (2U)
#define FLSLOADER_SW_PATCH_VERSION       (5U)
...
#define FLSLOADER_DFLASH_BANK_SIZE       (0x20000U)
...
#define FLSLOADER_NUM_OF_DF_SECTORS      (16U) 
