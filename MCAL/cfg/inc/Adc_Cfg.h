...
*/
#define ADC_DEBUG_SUPPORT         (STD_ON)
...
#define ADC_KERNEL_REQSRC0_USED  (0x0000U)
#define ADC_KERNEL_REQSRC1_USED  (0x0003U)
...
#define ADC_REQSRC_ARB_ENABLE          ((uint32)0x2)
...
/* ADC0 */
 ...
 #ifndef AdcConf_AdcGroup_Adc0_AutoScan /* to prevent double declaration */
 #define AdcConf_AdcGroup_Adc0_AutoScan   ((Adc_GroupType)0)
 #endif /* AdcConf_AdcGroup_Adc0_AutoScan */

/* ADC1 */

 #ifndef AdcConf_AdcGroup_Adc1_AutoScan /* to prevent double declaration */
 #define AdcConf_AdcGroup_Adc1_AutoScan   ((Adc_GroupType)32)
 #endif /* AdcConf_AdcGroup_Adc1_AutoScan */
