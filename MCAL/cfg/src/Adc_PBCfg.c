...
/* Adc0_AutoScan Group notification function declartion */
extern void Adc0_AutoScan_Notification(void);
/* Adc1_AutoScan Group notification function declartion */
...
{
  {
    ...
    &Adc_kCfg0Kernel0Adc0_AutoScan[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel1Adc1_AutoScan[0U],
