...
/* 
 *  Channel Number        : 0
 *  Channel Symbolic Name : Pwm_17_GtmConf_PwmChannel_HSD_PWMCLK 
...
*/
  {
    ...
    (Pwm_17_Gtm_PeriodType)250, /* Default Period */
...
/* 
 *  Channel Number        : 1
 *  Channel Symbolic Name : Pwm_17_GtmConf_PwmChannel_O_SL_08M 
 *  Channel Class         : PWM_FIXED_PERIOD
*/
  {
    Pwm_lConfigChannel(
    ...
    (Pwm_17_Gtm_PeriodType)480, /* Default Period */
    (uint32)0, /* Default Duty Cycle */
    (uint32)0, /* Shift Value */
...
/* 
 *  Channel Number        : 2
 *  Channel Symbolic Name : Pwm_17_GtmConf_PwmChannel_O_SL_07M 
 *  Channel Class         : PWM_FIXED_PERIOD
*/
  {
    Pwm_lConfigChannel(
    ...
    (Pwm_17_Gtm_PeriodType)240, /* Default Period */
    (uint32)0, /* Default Duty Cycle */
    (uint32)0, /* Shift Value */
...
/* 
 *  Channel Number        : 3
 *  Channel Symbolic Name : Pwm_17_GtmConf_PwmChannel_O_SL_10M 
...
*/
  {
    Pwm_lConfigChannel(
                        ...
                        PWM_LOW, /* channel Idle state */
                        PWM_HIGH, /* channel polarity */
                        GTM_TOM0_CHANNEL7 /* channel hardware resource */
                      ),
    (Pwm_17_Gtm_PeriodType)800, /* Default Period */
    (uint32)0, /* Default Duty Cycle */
    (uint32)0, /* Shift Value */
