...
/* Job: SpiJob_SPI_Ref Configuration */
  {
   /* Job End Notification: Spi_JobEndNotification, SPI118 */
    ...
    Spi_BaudRateParams(/*TQ*/(0x0U), /*Q*/(0x4U),
              /*A*/(0x0U), /*B*/(0x1U), /*C*/(0x3U)),

    /* Time Delay Configuration */
      (uint32)Spi_DelayParams(/*IPRE*/0x00U,/*IDLE*/ 0x00U,
        /*LPRE*/0x01U, /*LEAD*/0x04U,
        /*TPRE*/0x01U, /*TRAIL*/0x04U),
...
*/
/* Notification Function of Sequence: SpiSequence_SPI_Ref */
extern void Ref_EndOfCmdSeqNotification(void);

/*
Configuration: Job Assignment
*/
/* Job Assignment of Sequence: SpiSequence_SPI_Ref */
static const Spi_JobType SpiSequence_SPI_Ref_JobLinkPtr[] =
{
...
{   /* Sequence: SpiSequence_SPI_Ref Configuration */
  {
    /* Spi_SeqEndNotification */
    &Ref_EndOfCmdSeqNotification,
    /* User given name outside the naming convention */    /* Spi_JobLinkPtr */
    SpiSequence_SPI_Ref_JobLinkPtr,
    /* User given name outside the naming convention */
