...
*/
/* Gpt_100ms channel notification function declaration */
extern void Gpt_100ms_Notification(void);
...
static const Gpt_ChannelConfigType Gpt_kChannelConfig0[ ] =
{
  ...
  /* Channel Symbolic Name(ChannelId) : Gpt_100ms 
     GTM TOM/ATOM Channel : GTM_TOM0_CHANNEL1 in GPT_MODE_CONTINUOUS
  */ 
  {
    #if (GPT_ENABLE_DISABLE_NOTIFICATION_API == STD_ON)
    &Gpt_100ms_Notification, /* Notification Function */
    #endif
    ...
    #endif
    GTM_FIXED_CLOCK_3 /* Channel Clock frequency */
  }
};
